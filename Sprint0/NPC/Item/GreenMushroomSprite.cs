...
namespace Sprint0.NPC.Item
{
    internal class GreenMushroomSprite : MovingNoneAnimatedSprite
    {
        ...
        public GreenMushroomSprite(Texture2D texture, Vector2 position, int rowsIn, int colsIn, GraphicsDeviceManager graphics, int moveDirection) : base(texture, position, rowsIn, colsIn, graphics, moveDirection)
        {
